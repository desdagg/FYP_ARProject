...
public class BaseArActivity extends AppCompatActivity {
    ...
    public static final String GOOGLE_PLACE = "Google_Place";
    public static final String USER_PLACE = "User_Place";
    public static final String CURRENT_LOCATION = "Current_Location";

    private static final String TAG = BaseArActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * The following code is used to run different configurations of the BaseArActivity,
         ...
         * e.g.:
         *  AppData appData = new AppData.Builder("SAMPLE_NAME", "PATH_TO_AR_EXPERIENCE")
         ...
         *              .build();
         *
         * Intent intent = new Intent(this, BaseArActivity.class);
        ...
        final AppData appData = (AppData) intent.getSerializableExtra(INTENT_EXTRAS_KEY_SAMPLE);
        arExperience = appData.getPath();
        ...
        config.setCameraPosition(appData.getCameraPosition());       // The default camera is the first camera available for the system.
        config.setCameraResolution(appData.getCameraResolution());   // The default resolution is 640x480.
        config.setCameraFocusMode(appData.getCameraFocusMode());     // The default focus mode is continuous focusing.
        config.setCamera2Enabled(appData.isCamera2Enabled());        // The camera2 api is disabled by default (old camera api is used).
        config.setFeatures(appData.getArFeatures());                 // This tells the ArchitectView which AR-features it is going to use, the default is all of them.
