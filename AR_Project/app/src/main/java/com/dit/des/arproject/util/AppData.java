...
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_ACTIVITY;
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_AR_FEATURES;
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_CAMERA_2_ENABLED;
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_CAMERA_FOCUS_MODE;
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_CAMERA_POSITION;
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_CAMERA_RESOLUTION;
import static com.dit.des.arproject.util.DefaultConfigs.DEFAULT_DISPLAY_TYPE;
...
public class AppData implements Serializable {
    ...
    private AppData(@NonNull Builder builder) {
        name = builder.name;
        path = builder.path;
    ...
    public static class Builder {
        ...
        private @NonNull String displayType = DEFAULT_DISPLAY_TYPE;
        ...
        public Builder displayType(String type) {
