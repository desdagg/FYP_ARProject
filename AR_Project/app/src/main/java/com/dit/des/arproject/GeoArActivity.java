...
import com.dit.des.arproject.util.location.LocationProvider;
 ...
 * in addition to the required permissions of the BaseArActivity.
 */
public class GeoArActivity extends BaseArActivity implements LocationListener {
