...
import com.dit.des.arproject.fragments.SimpleArFragment;
import com.dit.des.arproject.fragments.UrlLauncherActivity;
import com.dit.des.arproject.util.PermissionUtil;
import com.dit.des.arproject.util.SampleCategory;
import com.dit.des.arproject.util.adapters.UrlLauncherStorageListAdapter;
...
public class UrlLauncherStorageActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    private SampleCategory sampleCategory = new SampleCategory(new ArrayList<AppData>(), URL_LAUNCHER_SAMPLE_CATEGORY);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, final int position, long id) {
        final AppData appData = sampleCategory.getSamples().get(position);
        ...
        permissionManager.checkPermissions(UrlLauncherStorageActivity.this, permissions, PermissionManager.WIKITUDE_PERMISSION_REQUEST, new PermissionManager.PermissionManagerCallback() {
            ...
            public void permissionsGranted(int requestCode) {
                ...
                intent.putExtra(SimpleArFragment.INTENT_EXTRAS_KEY_SAMPLE, appData);
                startActivity(intent);
            }
