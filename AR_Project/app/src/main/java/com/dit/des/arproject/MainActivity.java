...
import com.dit.des.arproject.util.urllauncher.UrlLauncherStorageActivity;
...
import com.dit.des.arproject.util.SampleJsonParser;
import com.dit.des.arproject.util.adapters.SamplesExpendableListAdapter;
//import com.dit.des.arproject.util.urllauncher.UrlLauncherStorageActivity;
...
public class MainActivity extends AppCompatActivity implements ExpandableListView.OnChildClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (Iterator<SampleCategory> catIt = categories.iterator(); catIt.hasNext(); ) {
            ...
            for (Iterator<AppData> dataIt = category.getSamples().iterator(); dataIt.hasNext(); ) {
                final AppData data = dataIt.next();
    ...
    public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
        final AppData appData = categories.get(groupPosition).getSamples().get(childPosition);
        ...
        permissionManager.checkPermissions(MainActivity.this, permissions, PermissionManager.WIKITUDE_PERMISSION_REQUEST, new PermissionManager.PermissionManagerCallback() {
            ...
            public void permissionsGranted(int requestCode) {
                final Intent intent = new Intent(MainActivity.this, appData.getActivityClass());
