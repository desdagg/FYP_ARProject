 ...
 */
public class LandingPageActivity extends AppCompatActivity implements TaskCompleted, SensorEventListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /**
         * Barometer sensor to get altitude
    ...
    @Override
    public void onAccuracyChanged(Sensor sens, int i){
        System.out.println("snesor accurnacy changed");
    }
        ...
        private void openApp(){
            ...
            session.setCurrentLatitude(mCurrentLocation.getLatitude());
            session.setCurrentLongitude(mCurrentLocation.getLongitude());
            session.setCurrentAltitude(mCurrentLocation.getAltitude());

            String userActivity = "walking";

            manager.updateUserCurrentLocation(this, session.getSessionUserId(),
                    session.getCurrentLatitude(), session.getCurrentLongitude(), session.getCurrentAltitude(), userActivity);
    ...
    private void createLocationCallback() {
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                Log.i(TAG, "****************  UonLocationResult Received  ***************");
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(LandingPageActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(LandingPageActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                        }
