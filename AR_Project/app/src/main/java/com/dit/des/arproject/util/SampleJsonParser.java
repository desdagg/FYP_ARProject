...
import com.dit.des.arproject.GeoArActivity;
    ...
    public static List<SampleCategory> getCategoriesFromJsonString(@NonNull String jsonString) {
        ...
        try {
            ...
            for (int i = 0; i < categoryArray.length(); i++) {
                ...
                final List<AppData> appData = new ArrayList<>();
                ...
                for (int u = 0; u < samplesArray.length(); u++) {
                    ...
                    if (extensions != null) {
                        ...
                        activityClass = GeoArActivity.class;
                    } else {
                        activityClass = BaseArActivity.class;
                    }

                    final AppData data = new AppData.Builder(name, path)
                ...
                list.add(new SampleCategory(appData, category_name));
            }
